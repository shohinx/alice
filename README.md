...
- `wiki/` contains the maintained synthesis layer.
- `outputs/` contains derived deliverables such as reports, slides, and figures.
...
- [wiki/concepts/persistent-wiki.md](wiki/concepts/persistent-wiki.md)
